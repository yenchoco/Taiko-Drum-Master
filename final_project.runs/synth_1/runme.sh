...
HD_PWD='C:/Users/user/Desktop/NTHU/verilog/course project/final project/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demo_2.tcl
