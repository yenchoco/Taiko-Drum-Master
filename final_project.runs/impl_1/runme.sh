...
HD_PWD='C:/Users/user/Desktop/NTHU/verilog/course project/final project/final_project/final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demo_2.tcl -notrace
